...
def summarize_survey(report_path: Path) -> dict:
    ...
    return {
        ...
        "n_unit_labels": info.get("n_unit_labels"),
        ...
        "units_per_corner_min": info.get("units_per_corner_min"),
        "units_per_corner_max": info.get("units_per_corner_max"),
        ...
        "confirmation_count_ready": info.get("confirmation_count_ready"),
