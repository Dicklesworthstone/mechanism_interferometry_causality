...
algebra above; or a deliberately restricted structural model with its own
falsifiers.  Joint Causal Inference makes context variables explicit,
invariant prediction identifies response predictors whose conditional law
survives environments, and BackShift identifies linear cyclic systems from
...
assumptions would revoke it; disagreement narrows the surviving model class
