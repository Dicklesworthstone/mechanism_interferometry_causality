...
\end{equation}
It uses independent Rademacher multipliers within the three law strata and a
max statistic across the frozen witnesses, with the declared unit, seed, and
witness-family fingerprint retained. This is an implemented reference
