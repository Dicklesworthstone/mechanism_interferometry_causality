...
now also ship a deterministic linear reference joint-regime model, cluster-level
outer cross-fitting with equal total weight per declared unit, and an exact
